#pragma once
#ifndef LDSO_TWITCH_ENERGY_FUNCTIONAL_H_
#define LDSO_TWITCH_ENERGY_FUNCTIONAL_H_
...
namespace ldso {
    namespace internal {
         ...
         * because I think they are the same.
         *
         ...
         * all the stuffs and keep them synchronized with FullSystem. Looks not good. Maybe for some historical reasons?
         *
         */
        ...
        public:
            ...
            // only friend can see your private and protected member variables
...
#endif // LDSO_TWITCH_ENERGY_FUNCTIONAL_H_
