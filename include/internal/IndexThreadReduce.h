#pragma once
#ifndef LDSO_TWITCH_INDEX_THREAD_REDUCE_H_
#define LDSO_TWITCH_INDEX_THREAD_REDUCE_H_
...
namespace ldso {
    ...
    namespace internal {
        ...
        /**
         * Multi thread tasks
         * use reduce function to parallelize a given task
...
#endif // LDSO_TWITCH_INDEX_THREAD_REDUCE_H_
