#pragma once
#ifndef LDSDO_TWITCH_IMAGE_AND_EXPOSURE_H_
#define LDSDO_TWITCH_IMAGE_AND_EXPOSURE_H_
...
namespace ldso
{
    ...
    class ImageAndExposure
    {
        ...
        float *image = nullptr; // Irradiance. Between 0 and 256 (TODO: Shouldnt this be 255 at max?)
        int w = 0, h = 0;
        double timestamp = 0;
...
#endif // LDSDO_TWITCH_IMAGE_AND_EXPOSURE_H_
