...
namespace ldso {
    ...
    bool CoarseInitializer::trackFrame(shared_ptr<FrameHessian> newFrameHessian) {
        ...
        for (int lvl = pyrLevelsUsed - 1; lvl >= 0; lvl--) {
            ...
            Vec8f b, bsc;
            resetPoints(lvl);
            Vec3f resOld = calcResAndGS(lvl, H, b, Hsc, bsc, refToNew_current, refToNew_aff_current, true);
            applyStep(lvl);
            ...
            while (true) {
                ...
                Vec8f b_new, bsc_new;
                Vec3f resNew = calcResAndGS(lvl, H_new, b_new, Hsc_new, bsc_new, refToNew_new, refToNew_aff_new, true);
