...
//#include <cstdio> /// TODO: Maybe remove that later?
#include <iostream> // Added by LwTV
...
namespace ldso {
    ...
    float setting_maxShiftWeightRT = 0.02f * (640 + 480); // Rotation + Translation?
    ...
    // 0 = nothing
    // 1 = apply inv. response (Gamma)
    // 2 = apply inv. response (Gamma) & remove Vignette.
    ...
    bool setting_forceAceptStep = true; // LwTV: Maybe it should be called "Accept"?

    float setting_useDepthWeightsCoarse = -1;
    bool setting_dilateDoubleCoarse = false;
    float setting_huberTH = 9;
    bool setting_logStuff = true; // whether to log
    ...
    // bool plotStereoImages = ; // NOT DEFINED in the original codebase
    ...
    int staticPattern[10][40][2] = {
       ...
       {{0,-2},{-1,-1},{1,-1},{-2,0},{0,0},{2,0},{-1,1},{1,1},{0,2},{-2,-2},{-2,2},{2,-2},{2,2},
